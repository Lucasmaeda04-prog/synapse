...
export class QueryDeckDto {
  ...
  @ApiProperty({ description: 'Texto para busca', required: false, example: 'matemática' })
  @IsOptional()
  @IsString()
  query?: string;

  @ApiProperty({ description: 'Filtrar por tags (separadas por vírgula)', required: false, example: 'matemática,básico' })
  @IsOptional()
  @IsString()
  tags?: string;
  ...
  @ApiProperty({ description: 'Campo de ordenação', required: false, example: 'created_at', enum: ['created_at', 'title', 'cards_count'] })
  @IsOptional()
  @IsString()
